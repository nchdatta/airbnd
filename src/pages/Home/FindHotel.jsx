        ...
        <div className='my-20 lg:w-4/6 mx-auto px-3'>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='p-12 border-2 border-yellow-400 rounded-3xl lg:rounded-full grid grid-cols-2 lg:grid-cols-4 gap-4'>
                    ...
                    <div className="relative">
                        <label htmlFor='traveler' className="absolute text-lg font-bold text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Traveler</label>
                        <input type='number' {...register('traveler', { required: true })} min='1' max='10' id='traveler' defaultValue='1' required placeholder='1' className='block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-full border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer' />
                    </div>
                </div>
