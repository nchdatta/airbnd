...
const Footer = () => {
    return (
        <footer className="pt-14 px-2 py-4 bg-gray-50 dark:bg-gray-900">
            <div className="pb-6 md:flex md:justify-between">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 className="mb-3 text-sm font-semibold text-gray-700 uppercase dark:text-white">Discover</h2>
                    ...
                    <div>
                        <h2 className="mb-3 text-sm font-semibold text-gray-700 uppercase dark:text-white">Legal</h2>
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-1">
                    ...
                    <div>
                        <h2 className="mb-3 text-sm font-semibold text-gray-700 uppercase dark:text-white">Contact</h2>
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-1">info@airbnd.com</li>
                            <li>+88 09678 332200</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to="/" className="hover:underline">airbnd</Link>. All Rights Reserved.
                </span>
